...
sns.kdeplot(gen["x1"],gen["x2"], ax=ax[0], color='red', label = genname)
sns.kdeplot(data["x1"],data["x2"], ax=ax[0], color='blue', label = filename)
ax[0].legend()
ax[0].set_title('x1 v x2')
sns.kdeplot(gen["x2"],gen["x3"], ax=ax[1], color='red', label = genname)
sns.kdeplot(data["x2"],data["x3"], ax=ax[1], color='blue', label = filename)
ax[1].legend()
ax[1].set_title('x2 v x3')
sns.kdeplot(gen["x3"], gen["x1"],ax=ax[2], color='red', label = genname)
