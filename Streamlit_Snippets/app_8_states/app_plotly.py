...
def run_app():
    ...
    # Session states 
    if 'print1' not in st.session_state:
        st.session_state['print1'] = False
        
    if 'print2' not in st.session_state:
        st.session_state['print2'] = False
    ######################
    df1 = None
    df2 = None
    global PATH_1
    ...
    if page == "Show Summary":
        ...
        if df2 is not None and df1 is not None:
            ...
            if print1:
                st.session_state.print1 = True
            if print2:
                st.session_state.print2 = True
            c1, c2 = st.columns(2)
            if st.session_state.print1:
                c1.dataframe(summary1)
                
            if st.session_state.print2:
                c2.dataframe(summary2)   
